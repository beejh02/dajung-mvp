...
- [x] 회원가입부터 키오스크 주문까지 E2E 확인
- [x] 로그인부터 AI 채팅 주문까지 E2E 확인
- [x] 더미 결제 후 포인트 적립 확인
- [x] 더미 결제 후 영수증 생성 확인
- [x] 관리자 대시보드 반영 확인
- [x] 키오스크 주문과 AI Agent 주문의 백엔드 파이프라인 공유 확인
- [x] 비로그인 사용자의 주문 제한 확인
- [x] handoff token 만료/재사용 방지 확인
- [x] 관리자 API 일반 사용자 접근 거부 확인
- [x] 더미 결제 승인 API 재시도 시 중복 포인트/영수증 미생성 확인
- [x] MCP tool 입력/출력 스키마와 실패 응답 확인
